...
public class ColorNombre : MonoBehaviour
{
    ...
    {
        play2 = Instantiate(player2, new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
        Destroy(play1, 0);
        Destroy(play3, 0);
    ...
    {
        play3 = Instantiate(player3, new Vector3(0, 0, 0), Quaternion.identity) as GameObject;
        Destroy(play1, 0);
        Destroy(play2, 0);
